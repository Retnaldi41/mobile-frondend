...
const Pricelist = ({ navigation }) => {
    ...
    const pesan = async (id_cosplay) => {
        let booking = { id_user: user.id_user, jenis_booking: 'Cosplay', id_item: id_cosplay, tanggal_booking: selectedDate, bukti_transfer: '', status: 1 }
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <ImageBackground source={ImageHeader} style={styles.header}>
                    <View style={styles.hello}>
                        <Text style={styles.selamat}>Cosplay</Text>
                ...
                <Modal
                    ...
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                            <Text style={styles.modalText}>Cosplay</Text>
                            <Image
                                style={{ Align: 'center', width: 100, margin: 10, height: 150 }}
                                source={{ uri: cos[selectedIndex]?.gambar_cosplay }}
                            />
                            <Text style={styles.valueSaldo}>{cos[selectedIndex]?.jenis_cosplay}</Text>
                            ...
                            /> */}
                                ...
                                <Pressable
                                    style={[styles.button, styles.buttonClose]}
                                    onPress={() => pesan(cos[selectedIndex]?.id_cosplay)}>
